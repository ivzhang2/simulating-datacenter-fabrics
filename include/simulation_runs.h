...
/*
        ...
        @discussion
        helper function for is_in_topology to check if two network objects are
   the same
...
/*
        ...
        @params
        struct network_object_t **path: pointer to array of network_objects that
   make up path size_t n_path: size of the network path
...
/*
        ...
        @discussion
        performs an union operation on the given topology, topo, and network
   path, path.

        @params
        struct topology_t* topo: pointer to topology object to be unioned
        struct network_object_t **path: pointer to array of network_objects to
   be unioned size_t n_path: size of the network path
