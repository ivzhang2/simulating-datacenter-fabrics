...
* the speed that can runs through the link (as a factor of the speed of light in the material) 
* the calculated delay per link, and the data rate (bandwidth) of the link in Mbps
*/
struct link_t {
